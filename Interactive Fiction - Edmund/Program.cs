...
namespace Interactive_Fiction___Edmund
{
    class Program
    {
        ...
        {                     
            ...
            story[4] = "The time it takes for you too get up is not fast enough, as the Rathian's toothy maw closes down on you.;You've Died;Press 2 to restart;4;4"; // death 1
            ...
            story[12] = "The flight becomes too much and your grip on the Rathian releases, its a long, long fall to the ground, and you think there's no way to walk away from this as the ground meets your face and sudden darkness envelopes your world.;You've died!;2: Quit;14;12"; // death 2
            story[13] = "You jump off the Rathian, as it flys up high and away. The End.;1: Restart;2: Quit;14;13"; // win 1
            story[14] = "With your knife drawn you stab the Rathian in the eye, and using its body as a brace you survive the landing, resulting in an unexpected hunt to be sure, but a welcome one. The End.;1: Restart;2: Quit;14;14"; // win 2
